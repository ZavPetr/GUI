...
export default function KontaktyPage() {
  const socialy = [
    { platforma: "Email", odkaz: "mailto:tvuj@email.cz", ikona: "✉️", text: "tvuj@email.cz" },
    { platforma: "Instagram", odkaz: "https://instagram.com", ikona: "📸", text: "@tvoje_jmeno" },
    { platforma: "GitHub", odkaz: "https://github.com", ikona: "💻", text: "github.com/tvoje" },
    { platforma: "Discord", odkaz: "#", ikona: "🎮", text: "StudentUser#1234" },
  ];
