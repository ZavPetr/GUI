    ...
    <main className="p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <Link href="http://localhost/index.php">
          <Card interactive className="hover:bg-orange-300 transition-colors">
            <h2 className="text-2xl font-bold mb-2">PHP example</h2>
            <p>Tady se nachází ukázka PHP pro předmět PRI</p>
          </Card>
        </Link>
      </div>
    </main>
