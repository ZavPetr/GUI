  ...
  return (
    <main className="p-10 max-w-2xl mx-auto">
      ...
      <div className="flex gap-2 mb-10">
        ...
        <button onClick={delAllTasks} className="text-red-500 font-bold px-3 hover:underline">
          Smazat Vše
        </button>
      </div>
        ...
        {tasks.map((u, i) => (
          <li key={i}>
            <Card className="flex justify-between items-center py-4">
              ...
              <button onClick={() => delTask(i)} className="text-red-500 font-bold hover:underline">
                Smazat
              </button>
            </Card>
          </li>
